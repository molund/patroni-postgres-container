...
RUN export DEBIAN_FRONTEND=noninteractive \
    ...
    && apt-get install -y postgresql-common libevent-2.1 libevent-pthreads-2.1 brotli libbrotli1 python3.6 python3-psycopg2 python3-yaml \
    ...
    && pip3 --isolated --no-cache-dir install ydiff==1.2 cdiff \
